#
# Module manifest for module 'CitrixPrinterAutomation'
#
...
RootModule = 'CitrixPrinterAutomation.psm1'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ProjectUri = 'https://github.com/techdecline/CitrixPrinterAutomation'
